...
# This code script takes 8 separate files; merges them together; transforms
# the data set into a tidy, usable form; summarizes the data; and outputs a
# summary file. All files must be in the working directory. They can be
# downloaded from:
#
# https://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip 
#
# A description of the data and the project is here:
#
# http://archive.ics.uci.edu/ml/datasets/Human+Activity+Recognition+Using+Smartphones 
#
#
# CODE SECTIONS AND OUTPUT DESCRIPTION:
# SECTION 0. Import files (listed in section below)
# SECTION 1. Merge all files into a single data set (data table)
# SECTION 2. Subset the data on only mean and standard deviation
# SECTION 3. Add/merge descriptive activity names (described more below)
# SECTION 4. Provide tidy, descriptive variable/column names
# SECTION 5. Summarize the data by Subject and Activity and output a file
